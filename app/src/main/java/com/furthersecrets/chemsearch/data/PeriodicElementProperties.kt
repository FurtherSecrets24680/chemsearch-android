...
// Source: PubChem machine-readable periodic table data.
// https://pubchem.ncbi.nlm.nih.gov/rest/pug/periodictable/JSON
const val PUBCHEM_PERIODIC_TABLE_SOURCE_URL = "https://pubchem.ncbi.nlm.nih.gov/rest/pug/periodictable/JSON"

data class PeriodicElementProperties(
...
val PubChemPeriodicElementProperties: Map<String, PeriodicElementProperties> = listOf(
